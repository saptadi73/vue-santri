    ...
    <div class="header-section">
      ...
      <div>
        ...
        <p class="text-gray-600">
          Proses persetujuan pengalokasian anggaran bantuan pesantren
        </p>
      </div>
    </div>
      ...
      <div class="form-column">
        ...
        <div class="form-card">
          ...
          <div class="card-content">
            ...
            <div class="form-group">
              <label class="form-label">Nama Pesantren <span class="required">*</span></label>
              <input
                v-model="formData.namaPesantren"
                type="text"
                class="form-input"
