<template>
  <div class="lembar-dokumen-container">
    ...
    <div class="header-section">
      ...
      <div>
        <h2 class="text-2xl font-bold text-gray-800 mb-2">
          Lembar Dokumen - {{ pesantrenData.namaPesantren }}
        </h2>
        <p class="text-gray-600">
          No. Pengajuan: {{ pesantrenData.noPengajuan }}
        </p>
      </div>
    </div>
    ...
    <div class="document-grid-layout">
      ...
      <!-- Column 1: Dokumen Legalitas -->
      <div class="document-column">
        <div class="document-card">
          <h3 class="card-title">📄 Dokumen Legalitas Pesantren</h3>
          <div class="card-content">
            <div class="document-list">
              <div
                v-for="(doc, index) in pesantrenData.dokumenLegalitas"
                :key="index"
        ...
        <div class="document-card">
          <h3 class="card-title">🎥 Video Profil Pesantren</h3>
          <div class="card-content">
            <div class="video-list">
              <div
                v-for="(video, index) in pesantrenData.videoProfil"
                :key="index"
      ...
      <!-- Column 2: Dokumen Pengajuan Bantuan -->
      <div class="document-column">
        <div class="document-card">
          <h3 class="card-title">📋 Dokumen Pengajuan Bantuan</h3>
          <div class="card-content">
            <div class="document-list">
              <div
                v-for="(doc, index) in pesantrenData.dokumenPengajuan"
                :key="index"
                @click="viewDocument(doc)"
                class="document-item-card"
              >
        ...
        <div class="document-card">
          <h3 class="card-title">📷 Foto Verifikasi Lapangan</h3>
          <div class="card-content">
            <div class="photo-grid-compact">
              <div
                v-for="(photo, index) in pesantrenData.photos"
                :key="index"
      ...
      <div class="document-column">
        <div class="document-card">
          <h3 class="card-title">🎬 Video Verifikasi Lapangan</h3>
          <div class="card-content">
            <div class="video-list">
              <div
                v-for="(video, index) in pesantrenData.videoVerifikasi"
                :key="index"
                @click="viewVideo(video)"
                class="video-item-card"
              >
...
const pesantrenData = ref({
  ...
  dokumenLegalitas: [
    {
      name: 'Akta Pendirian Yayasan.pdf',
      url: '#',
      size: '345 KB',
      date: '10 Jan 2024'
    },
    {
      name: 'SK Kemenkumham Yayasan.pdf',
      url: '#',
      size: '412 KB',
      date: '10 Jan 2024'
    },
    {
      name: 'Izin Operasional Pesantren.pdf',
      url: '#',
      size: '298 KB',
      date: '12 Jan 2024'
    },
    {
      name: 'Sertifikat Tanah Pesantren.pdf',
      url: '#',
      size: '523 KB',
      date: '12 Jan 2024'
    },
    {
      name: 'IMB (Izin Mendirikan Bangunan).pdf',
      url: '#',
      size: '456 KB',
      date: '15 Jan 2024'
    },
    {
      name: 'Sertifikat Laik Fungsi (SLF).pdf',
      url: '#',
      size: '389 KB',
      date: '15 Jan 2024'
    },
    {
      name: 'NPWP Yayasan Pesantren.pdf',
      url: '#',
      size: '156 KB',
      date: '10 Jan 2024'
    },
    {
      name: 'Struktur Organisasi Pesantren.pdf',
      url: '#',
      size: '234 KB',
      date: '12 Jan 2024'
    }
  ...
  dokumenPengajuan: [
    ...
    {
      name: 'Proposal Pengajuan Bantuan.pdf',
      url: '#',
      size: '1.8 MB',
      date: '18 Jan 2024'
    },
    {
      name: 'RAB (Rencana Anggaran Biaya).pdf',
      url: '#',
      size: '567 KB',
      date: '18 Jan 2024'
    },
    {
      name: 'Data Santri Aktif.pdf',
      url: '#',
      size: '421 KB',
      date: '18 Jan 2024'
    },
    {
      name: 'Laporan Keuangan Pesantren.pdf',
      url: '#',
      size: '789 KB',
      date: '18 Jan 2024'
    },
    {
      name: 'Surat Rekomendasi Kemenag.pdf',
      url: '#',
      size: '234 KB',
      date: '20 Jan 2024'
    },
    {
      name: 'Berita Acara Verifikasi Lapangan.pdf',
      url: '#',
      size: '1.2 MB',
      date: '25 Jan 2024'
    },
    {
      name: 'Laporan Hasil Verifikasi.pdf',
      url: '#',
      size: '945 KB',
      date: '25 Jan 2024'
    },
    {
      name: 'Surat Pernyataan Pengasuh.pdf',
      url: '#',
      size: '198 KB',
      date: '18 Jan 2024'
    },
    {
      name: 'Rekening Bank Pesantren.pdf',
      url: '#',
      size: '167 KB',
      date: '18 Jan 2024'
    }
  ...
  photos: [
    {
      name: 'Foto Gerbang Pesantren',
      url: '/cowok1.jpg'
    },
    {
      name: 'Foto Gedung Utama',
      url: '/cowok1.jpg'
    },
    {
      name: 'Foto Asrama Santri Putra',
      url: '/cowok1.jpg'
    },
    {
      name: 'Foto Asrama Santri Putri',
      url: '/cowok1.jpg'
    },
    {
      name: 'Foto Masjid Pesantren',
      url: '/cowok1.jpg'
    },
    {
      name: 'Foto Ruang Kelas',
      url: '/cowok1.jpg'
    },
    {
      name: 'Foto Perpustakaan',
      url: '/cowok1.jpg'
    },
    {
      name: 'Foto Dapur Umum',
      url: '/cowok1.jpg'
    },
    {
      name: 'Foto Sanitasi & MCK',
      url: '/cowok1.jpg'
    },
    {
      name: 'Foto Area Parkir',
      url: '/cowok1.jpg'
    },
    {
      name: 'Foto Kantor Pesantren',
      url: '/cowok1.jpg'
    },
    {
      name: 'Foto Lapangan Olahraga',
      url: '/cowok1.jpg'
    }
  ],
  videoProfil: [
    {
      title: 'Profil Lengkap Pesantren',
    ...
    },
    {
      ...
      videoId: '9bZkp7q19f0',
      category: 'Aktivitas Pembelajaran'
    },
    {
    ...
    {
      title: 'Wawancara dengan Pengasuh',
  ...
  videoVerifikasi: [
    {
      title: 'Verifikasi Kondisi Bangunan',
      url: 'https://www.youtube.com/watch?v=jNQXAC9IVRw',
      videoId: 'jNQXAC9IVRw',
      category: 'Verifikasi Bangunan'
    },
    {
      title: 'Verifikasi Asrama & Fasilitas',
      url: 'https://www.youtube.com/watch?v=ZZ5LpwO-An4',
      videoId: 'ZZ5LpwO-An4',
      category: 'Verifikasi Fasilitas'
    },
    {
      title: 'Survey Jumlah Santri Aktif',
      url: 'https://www.youtube.com/watch?v=L_jWHffIx5E',
      videoId: 'L_jWHffIx5E',
      category: 'Survey Santri'
    },
    {
      title: 'Wawancara Tim Verifikasi',
      url: 'https://www.youtube.com/watch?v=YQHsXMglC9A',
      videoId: 'YQHsXMglC9A',
      category: 'Wawancara Verifikasi'
    },
    {
      title: 'Dokumentasi Kegiatan Harian',
      url: 'https://www.youtube.com/watch?v=kJQP7kiw5Fk',
      videoId: 'kJQP7kiw5Fk',
      category: 'Aktivitas Harian'
    },
    {
      title: 'Kondisi Sanitasi & Kesehatan',
      url: 'https://www.youtube.com/watch?v=9bZkp7q19f0',
      videoId: '9bZkp7q19f0',
      category: 'Sanitasi'
    }
...
const loadDataFromRoute = () => {
  if (route.params.data) {
    ...
    pesantrenData.value.noPengajuan = data.noPengajuan || ''
    pesantrenData.value.namaPesantren = data.namaPesantren || ''
  }
}
