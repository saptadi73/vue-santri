    ...
    <div class="header-section">
      <div>
        <h2 class="text-2xl font-bold text-gray-800 mb-2">
          Pengalokasian Bantuan Santri
        </h2>
        <p class="text-gray-600">
          Data pengalokasian anggaran bantuan untuk santri yang telah diverifikasi
        </p>
      </div>
      ...
      <table class="data-table">
        ...
        <tbody>
          <tr v-for="(alokasi, index) in paginatedData" :key="alokasi.noPengajuan">
            ...
            <!-- Data Pengajuan (No. Pengajuan + Nama Santri) -->
            <td class="sticky-col-2">
              <div class="data-group">
                <div class="data-name clickable-name" @click="editData(alokasi)">
                  {{ alokasi.noPengajuan }}
                </div>
                <div class="data-detail">{{ alokasi.namaSantri }}</div>
              </div>
            </td>
          ...
          <div class="detail-grid">
            <div class="detail-section">
              ...
              <div class="detail-item">
                ...
                <span class="detail-value">{{ selectedAlokasi.namaSantri }}</span>
              </div>
            </div>
...
const alokasiData = reactive([
  ...
  },
  {
    ...
    alokasiAnggaran: 'Kemenag',
    lembaga: '',
    noMataAnggaran: 'MAK-2024-005',
    jumlahPengajuan: 4800000,
    jumlahDisetujui: 4500000,
    status: 'Pemeriksa 2 Disetujui'
  }
])
...
const filteredData = computed(() => {
  ...
  if (searchQuery.value) {
    ...
    data = data.filter(alokasi => 
      ...
      alokasi.namaSantri.toLowerCase().includes(query) ||
